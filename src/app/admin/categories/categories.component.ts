...
import { Product, Category, User, Tag } from './../../modal/Modal';
...
export class CategoriesComponent implements OnInit {
  ...
  constructor(private productService: ProductService, private categoryService: CategoryService,
    private route: ActivatedRoute, private dialog: MatDialog, private userService: UserService, private tagService: TagService) {
